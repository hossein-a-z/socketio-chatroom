...
This project is based on Hossein Pira's repo. just tried to make it more blackout friendly. Now it doesn't need any api or outside source. All Local and can be easily deployed with npm
...
1. Clone the repository:
    ```bash
    git clone https://github.com/hossein-a-z/socketio-chatroom
